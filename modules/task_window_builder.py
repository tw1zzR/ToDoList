from core.manage_data import get_task_data_from_dialog
from PyQt5.QtCore import *
from PyQt5.QtGui import *

def limit_text_length(task_input_dialog):
...
def setup_connections(task_window):
    if task_window.is_input:
        ...
        task_window.send_button.clicked.connect(lambda: get_task_data_from_dialog(task_window))
