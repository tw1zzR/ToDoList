...
class ComboBoxWithButton(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("Комбобокс с кнопкой")
        ...
        self.menu_button.setIcon(QIcon("menu_icon.png"))  # Путь к иконке
        self.menu_button.setPopupMode(QToolButton.InstantPopup)  # Меню появляется сразу
        ...
        for option in options:
            ...
            action.triggered.connect(lambda checked, text=option: self.option_selected(text))
